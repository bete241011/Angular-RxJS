...
export class ProductService {
  ...
  // Combining all the streams ## get it all approach
  ...
  // Combining all the streams ## just in time approach
  selectedProductSuppliers$ = this.selectedProduct$
    .pipe(
      /* Filter uses to skip process if the selected product is undefined or null
      *  this happens when the page is first displayed before the user has selected a product
      */
